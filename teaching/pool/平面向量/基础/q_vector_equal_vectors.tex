% =====================================================
% 题型：矩形内相等向量对数填空题 (q_vector_equal_vectors.tex)
% =====================================================
% 难度：★ (基础)
% =====================================================
...
\newcommand{\qVectorEqualVectorsDiagnosis}{%
  若只得到约 2 对，通常说明只捕捉到局部相等关系，没有按方向完整分类。应检查是否漏掉反方向向量，以及两条对角线被中点分出的半向量。%
}

\newcommand{\qVectorEqualVectorsTeachingNotes}{%
  讲评时要求按水平方向、竖直方向、对角线 \(AC\)、对角线 \(BD\) 四类列清单，形成“不重不漏”的计数习惯。%
}
