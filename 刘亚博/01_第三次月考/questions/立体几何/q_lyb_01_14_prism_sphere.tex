% =====================================================
% 题型：直三棱柱外接球填空题 (q_lyb_01_14_prism_sphere.tex)
% =====================================================
\newcommand{\qLYBZeroOneFourteenStem}{在直三棱柱 \(ABC-A_1B_1C_1\) 中，\(2AB = AA_1 = 2\)，若该三棱柱的外接球的表面积为 \(8\pi\)，则 \(\angle ACB\) 的大小为 \underline{\hspace{2.5cm}}。}

\newcommand{\qLYBZeroOneFourteenFigure}[1][1.3]{%
  \begin{tikzpicture}[scale=#1, >=stealth]
    % Coordinates of bottom triangle ABC
    \coordinate (A) at (0,0);
    \coordinate (B) at (1.2,-0.4);
    \coordinate (C) at (1.8,0.2);
    
    % Coordinates of top triangle A1B1C1
    \coordinate (A1) at (0,1.8);
    \coordinate (B1) at (1.2,1.4);
    \coordinate (C1) at (1.8,2.0);
...
\newcommand{\qLYBZeroOneFourteenAnswer}{\(\dfrac{\pi}{6}\) 或 \(\dfrac{5\pi}{6}\)}

\newcommand{\qLYBZeroOneFourteenSolution}{%
  ...
  所以 \(\angle ACB = \dfrac{\pi}{6}\) 或 \(\angle ACB = \dfrac{5\pi}{6}\)（即 \(30^\circ\) 或 \(150^\circ\)）。
  故填 \(\dfrac{\pi}{6}\) 或 \(\dfrac{5\pi}{6}\)。%
}
