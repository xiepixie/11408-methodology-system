...
% =====================================================
\newcommand{\qLYBZeroOneThirteenStem}{如图，在长方体 \(ABCD-A_1B_1C_1D_1\) 中，\(AD = AA_1 = \dfrac{1}{2} AB = 2\)，\(\vec{A_1P} = \dfrac{3}{4}\vec{AB} + \dfrac{1}{4}\vec{A_1D_1}\)，则过点 \(C, D_1, P\) 的平面截长方体的截面周长为 \underline{\hspace{2.5cm}}。}

\newcommand{\qLYBZeroOneThirteenFigure}[1][1.3]{%
...
\newcommand{\qLYBZeroOneThirteenAnswer}{\(4\sqrt{5} + 2\sqrt{2}\)}

\newcommand{\qLYBZeroOneThirteenSolution}{%
