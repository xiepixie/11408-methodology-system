...
% =====================================================
\newcommand{\qLYBZeroOneEightStem}{已知点 \(O\) 在 \(\triangle ABC\) 所在平面内，满足 \(|\vec{OA}| = |\vec{OB}| = |\vec{OC}|\)，且 \(\vec{AO} = 2\vec{AB} + 3\vec{AC}\)，则 \(\cos 2\angle BAC =\) \hfill （\quad）}

\newcommand{\qLYBZeroOneEightOptions}{%
  \mcoptions[4]{\(-\dfrac{1}{4}\)}{\(-\dfrac{5}{8}\)}{\(\dfrac{3}{4}\)}{\(\dfrac{1}{4}\)}%
}

\newcommand{\qLYBZeroOneEightAnswer}{D}

\newcommand{\qLYBZeroOneEightSolution}{%
