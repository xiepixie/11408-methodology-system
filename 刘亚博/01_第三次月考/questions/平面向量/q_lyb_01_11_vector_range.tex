% =====================================================
% 题型：向量圆轨迹模长最值多选题 (q_lyb_01_1_vector_range.tex)
% =====================================================
\newcommand{\qLYBZeroOneElevenStem}{已知单位向量 \(\vec{a}, \vec{b}\) 满足 \(|2\vec{a} - \vec{b}| = 2\)，若向量 \(\vec{c}\) 满足 \((\vec{c} - 2\vec{a}) \cdot (\vec{c} - \vec{b}) = 0\)，则 \(|\vec{c}|\) 的取值可以是 \hfill （\quad）}

\newcommand{\qLYBZeroOneElevenOptions}{%
  \mcoptions[4]{\(\dfrac{1}{5}\)}{\(\sqrt{3}\)}{\(2\)}{\(\sqrt{5}\)}%
}

\newcommand{\qLYBZeroOneElevenAnswer}{B, C}

\newcommand{\qLYBZeroOneElevenSolution}{%
