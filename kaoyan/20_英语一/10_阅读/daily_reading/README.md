...
| 某项长期能力状态或稳定缺陷 | `03_capabilities/*.md` |
| 系统规则 | `00_system/*.md` |
...
这里尽量接近真实阅读环境。除了标题和必要来源信息，不提前给答案、总结或表达提示。
...
- 可复用表达 → `02_expressions/`
- 稳定能力状态 / 代表性证据 → `03_capabilities/`
