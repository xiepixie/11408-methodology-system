...
- 单一定向积分/向量场问题族的题目触发信号、第一动作、检查点和退出条件由同目录训练 Markdown 维护；只有跨多个训练专题的稳定控制才进入高等数学 Subject Rules。
...
- [定向积分与向量场定理选择](定向积分与向量场定理选择.md) —— 场×载体分类、参数化与定向、保守场，以及 Green/Stokes/Gauss 的资格与成本分流。
...
- Published View：[定向积分与向量场.pdf](../../../90_publish/math1/定向积分与向量场.pdf)
