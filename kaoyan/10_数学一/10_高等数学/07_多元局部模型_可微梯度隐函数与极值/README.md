...
- [复合偏导与变量变换](复合偏导与变量变换.md) —— 偏导固定变量身份、复合树、高阶链式、多约束导数与 PDE 变量变换中的 Jacobian 组织；
...
归档笔记 II-01、II-02、II-02.1、II-03、II-03.1 及《高数下册进阶》专题 1 已完成当前轮 Source Diff / Owner Diff；逐项路由见 [`2026-08-18_高数下册进阶_Source_Diff.md`](../../../80_evidence/review_log/2026-08-18_高数下册进阶_Source_Diff.md)。新增材料已按“偏导固定变量身份—复合/高阶链式—全微分反求—PDE 变量变换—可微边界—极值主部”分别进入 Canonical 或同目录训练文档。源材料中把“线性主部固定为 0”的条件误写成一般可微充要条件、把复合高阶偏导误标成隐函数高阶偏导等说法均未进入 Canonical，而作为边界/纠错证据保留。正文与训练文档仍需使用者审阅和陌生题验证，当前不标记为“已采用”。
