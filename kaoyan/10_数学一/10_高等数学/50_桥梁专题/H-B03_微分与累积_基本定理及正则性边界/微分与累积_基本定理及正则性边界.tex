...
若 $f$ 在 $[a,b]$ Riemann 可积，则它有界，设 $\lvert f\rvert\le M$。于是
\[
\lvert G(y)-G(x)\rvert
=\left\lvert\int_x^y f(t)\,dt\right\rvert
\le M\lvert y-x\rvert.
\]
...
\begin{center}
\input{assets/src/shrinking_average_body.tikz}
\end{center}
...
\begin{center}
\input{assets/src/leibniz_three_contributions_body.tikz}
\end{center}
