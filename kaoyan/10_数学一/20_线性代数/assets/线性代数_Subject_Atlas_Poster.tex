...
在本体系中，行列式不是一套孤立计算。它首先服务于方阵线性作用：是否压扁了满维空间、是否可逆、体积缩放是否为零。展开、代数余子式、伴随矩阵为什么合法由 Topic 02 的 Canonical 正文处理；具体行列式问题族如何快速选路线由 Topic 02 同目录训练 Markdown 承担，只有跨专题稳定复用并经证据验证的控制才晋升学科规则。
\end{warnbox}
