# 2021 年 408｜Derived Solution Layer

> 状态：Q1～Q47 已完成 `model-grounded-v1`。本目录只拥有题解，不拥有题面；题面事实唯一来自 `../2021 年全国硕士研究生招生考试.md`。

## 阅读入口

- [[../2021 年全国硕士研究生招生考试|Canonical Exam Source]]
...
- Legacy `qNN_*.md` 只作为旧解析参考，不得覆盖 Canonical Source 或独立推理。
...
- 发现 Source 与题目逻辑发生硬冲突时先修 Source；发现 legacy 解析错误只修 Derived Solution，不污染 Source。