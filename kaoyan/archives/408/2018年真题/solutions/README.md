# 2018 年 408｜Derived Solution Layer

> 状态：Q1～Q47 已完成 `model-grounded-v1`。本目录只拥有题解，不拥有题面；题面事实唯一来自 `../2018 年全国硕士研究生招生考试.md`。

## 阅读入口

- [[../2018 年全国硕士研究生招生考试|Canonical Exam Source]]
...
- 发现 Source 与题目逻辑发生硬冲突时，先核对 Source；本年 Canonical 未发现需要改写题意的实质错误。