...
本目录保存 2009～2026 年 408 真题的抓取原料与正式可编辑版本，并维护与历年真题严格隔离的非真题练习题库。

## 目录约定

除年度真题外，`题库/` 用于保存经过逐题审校的非真题练习来源。它不属于 Canonical Exam Source，不得据此声称题目来自统考真题；题面与审校/答案分文件维护，避免练习时答案污染题面。
