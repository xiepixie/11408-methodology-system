...
\begin{center}
\input{assets/src/multilevel_page_table_body.tikz}
\end{center}
...
\subsection{统一处理流程}
\begin{center}
\resizebox{0.96\linewidth}{!}{\input{assets/src/page_fault_lifecycle_body.tikz}}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{\input{assets/src/clock_replacement_body.tikz}}
\end{center}
