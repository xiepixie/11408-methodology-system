...
\begin{warn}[P 操作顺序的判断原则]
不要机械背“所有题都先同步后互斥”。应按以下规则判断：
\begin{center}
...
\small
\renewcommand{\arraystretch}{1.25}
\begin{longtable}{>{\bfseries}p{0.20\linewidth} p{0.32\linewidth} p{0.40\linewidth}}
\toprule
经典同步题型 & 共享对象与约束关系 & 解题第一反应与建模板块\\
\midrule
\endfirsthead
\toprule
经典同步题型 & 共享对象与约束关系 & 解题第一反应与建模板块\\
...
\small
\renewcommand{\arraystretch}{1.25}
\begin{longtable}{>{\bfseries}p{0.24\linewidth} p{0.35\linewidth} p{0.33\linewidth}}
\toprule
错误现象 & 根本认知缺口 & 修复与排查提问\\
\midrule
\endfirsthead
