...
\begin{center}
\resizebox{0.96\linewidth}{!}{\input{30_408/40_计算机网络/07_拥塞_共享资源与反馈控制/assets/src/tcp_congestion_curve_body.tikz}}
\end{center}
图只固定经典 408 的反馈结构：Slow Start 快增、Congestion Avoidance 加性试探、3 DupACK 的温和退让与 Timeout 的强退让。具体门限、初值与 recovery 临时膨胀必须服从题设版本。
