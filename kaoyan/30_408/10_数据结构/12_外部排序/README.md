...
## Manual
- Canonical：[外部排序：方法论手册 (TeX)](DS12_外部排序_方法论手册.tex)
- Published：[外部排序：方法论手册 (PDF)](../../../90_publish/408/DS12_外部排序_方法论手册.pdf)
- 完整实现：[`ds12_external_sort.hpp`](code/ds12_external_sort.hpp)
- 边界测试：[`ds12_external_sort_test.cpp`](code/ds12_external_sort_test.cpp)

## 训练导航
- [多路归并、败者树与虚段](多路归并、败者树与虚段.md)：$N/M/r/k$ 参数账本 → 缓冲约束 → 归并趟数/I/O → 败者树 → $k$ 叉最佳归并树虚段。
