# AGENTS
> Scope: `kaoyan/` and descendants. Upper-level instructions still apply.
...
```
Scenarios: `explore / model-diff / solve / exam-solution / wrong / adversary / practice / import / review / publish`.
...
90_publish/<category>/*.pdf       = compiled reading / visual view (math1, english1, 408, system)
...
| Archive maintenance tool execution semantics | `00_system/tools/README.md` |
...
python3 00_system/check_handbook_template.py                 # if Handbook template / LaTeX contract changed
