...
| `exam_source_conversion_spec.md` | 拥有跨考试共用的 Exam Source 目录、元数据、PDF/图形转译与验收规范 |
| `exam_solution_agent_prompt.md` | 拥有基于心智模型批量重写真题题解的 Agent 执行顺序、最小 Context 与批量纪律 |
| `exam_solution_authoring_spec.md` | 拥有跨考试共用的 Derived Solution 写作结构、Source/Model/Verification/Compression Gate 与 Evidence 回流边界 |
| `exam_solution_quality_assurance.md` | 拥有题解面向学生的学习责任、跨年度风格一致性、质量 Gate、Model Feedback Closure 与机器/人工验收边界 |
...
| `check_handbook_template.py` | 验证新 Handbook Forward Template 使用正式 Family API、Canonical semantic API 且 strict 编译通过 |
| `tools/README.md` | 拥有 Kaoyan Archive 批处理工具的读写边界、显式 scope、`--force` 与可重跑性合同 |
...
- [真题 Source Agent Prompt](00_system/exam_source_agent_prompt.md)
- [真题 / 试卷 Source 转译规范](00_system/exam_source_conversion_spec.md)
- [真题题解 Agent Prompt](00_system/exam_solution_agent_prompt.md)
- [真题题解：心智模型驱动写作规范](00_system/exam_solution_authoring_spec.md)
- [真题题解质量保证与学生学习合同](00_system/exam_solution_quality_assurance.md)
...
- [Kaoyan 批处理工具执行合同](00_system/tools/README.md)
