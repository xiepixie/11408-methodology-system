...
\subsection{1. 不变量与标准形：寻找“变了以后仍没变的东西”}
分类问题的典型路线是：
\[
...
\subsection{3. 局部—整体：简单局部怎样拼成复杂整体？}
很多理论都遵循：
\[
...
\subsection{5. 完备化与弱化：原空间装不下极限时怎么办？}
...
\subsection{6. 存在—唯一—稳定：一个问题是否真正“可解”}
Hadamard 式思维要求分别检查：
\[
