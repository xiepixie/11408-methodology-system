...
\begin{methodbox}{两侧 Owner 与本 Bridge 的唯一职责}
\begin{itemize}
\item CO-07 Own VPN/offset、TLB、PTE、page walk、权限与 PA 形成；
\item CO-06 Own block、set、tag、valid/dirty、hit/miss、替换与写策略；
\item CO-B02 只 Own 两侧数据包、地址位交接、串并行条件、别名风险与 slow-path 路由。
\end{itemize}
\end{methodbox}
