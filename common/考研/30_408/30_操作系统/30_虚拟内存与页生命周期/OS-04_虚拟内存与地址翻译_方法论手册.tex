...
\[
\text{State (PTE/Frame/Disk)}
\to\text{Page Fault (缺页异常)}
...
CLOCK / 二次机会算法利用 PTE 中的 Reference Bit，将“精确的时间全序”退化为“分批重置的访问标志（Approximate Recency）”，在牺牲极微小准确度的前提下，消除了每次访存维护链表的开销！
\end{method}
...
\]
它们的关系是“工作集提供对象层预测，PFF 提供结果层反馈”。两者都只能说明风险与调节方向，不能推出“某个瞬间工作集总和超过内存就必然已经发生颠簸”。
