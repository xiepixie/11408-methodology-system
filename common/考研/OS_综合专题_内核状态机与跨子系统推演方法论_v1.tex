...
\begin{center}
\begin{tikzpicture}[x=2.90cm,y=1.60cm]
  ...
  \draw[relation] (fd) -- node[labelnote,above]{Reference} (file);
  \draw[relation] (file) -- node[labelnote,above]{Reference} (inode);
  \draw[relation] (va) -- node[labelnote,above]{Mapping} (pte);
  \draw[relation] (pte) -- node[labelnote,above]{Mapping} (frame);
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[x=2.85cm,y=1.65cm]
  ...
  \draw[mainflow] (u) -- node[labelnote,above]{1. Syscall} (fs);
  \draw[mainflow] (fs) -- node[labelnote,above]{2. Lookup} (pc);
  \draw[mainflow] (pc) -- node[labelnote,above]{3. Miss} (io);
  \draw[mainflow] (io) -- node[labelnote,right]{4. Block} (blk);
  \draw[mainflow] (blk) -- node[labelnote,below]{5. IRQ} (irq);
  \draw[mainflow] (irq) -- node[labelnote,below]{6. Wakeup} (ready);
  \draw[mainflow] (ready) -- node[labelnote,below]{7. Return} (ret);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[x=2.85cm,y=1.65cm]
  ...
  \draw[mainflow] (req) -- node[labelnote,above]{1. Demand} (press);
  \draw[mainflow] (press) -- node[labelnote,above]{2. Trigger} (victim);
  \draw[mainflow] (victim) -- node[labelnote,above]{3. Policy} (type);
  \draw[mainflow] (type) -- node[labelnote,right]{4. Inspect} (action);
  \draw[mainflow] (action) -- node[labelnote,below]{5. Reclaim} (io);
  \draw[mainflow] (io) -- node[labelnote,below]{6. Complete} (free);
  \draw[mainflow] (free) -- node[labelnote,below]{7. Restored} (retry);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[x=2.85cm,y=1.65cm]
  ...
  \draw[relation] (fd) -- node[labelnote,above]{Handle} (file);
  \draw[relation] (file) -- node[labelnote,above]{Open Ref} (inode);
  \draw[relation] (name) -- node[labelnote,above]{Name Ref} (inode);
  \draw[mainflow] (name) -- node[labelnote,right]{Event} (unlink);
  \draw[danger,densely dashed] (unlink) -- node[labelnote,below]{Drop Name Edge} (alive);
  \draw[mainflow] (alive) -- node[labelnote,left]{Keep Inode} (file);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[x=2.85cm,y=1.65cm]
  ...
  \draw[mainflow] (s) -- node[labelnote,above]{1. State} (e);
  \draw[mainflow] (e) -- node[labelnote,above]{2. Trigger} (m);
  \draw[mainflow] (m) -- node[labelnote,above]{3. Allow} (p);
  \draw[mainflow] (p) -- node[labelnote,right]{4. Select} (n);
  \draw[mainflow] (n) -- node[labelnote,below]{5. Update} (i);
  \draw[mainflow] (i) -- node[labelnote,below]{6. Invariant} (c);
  \draw[mainflow] (c) -- node[labelnote,below]{7. Cost} (a);
\end{tikzpicture}
\end{center}
