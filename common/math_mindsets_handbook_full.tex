...
\input{pool/解析几何/基础/q_hyperbola_eccentricity.tex}
\input{pool/函数与图象/中档/q_func_max_val_parameter.tex}
\input{pool/解析几何/难题/q_conic_circle_chords.tex}
\input{pool/数列/难题/q_seq_max_ratio.tex}
\input{pool/函数与图象/难题/q_func_subset_relation.tex}
\input{pool/立体几何/中档/q_solid_prism_distance.tex}
...
\input{pool/立体几何/中档/q_solid_opening_cube_relations.tex}
\input{pool/立体几何/中档/q_solid_opening_pyramid_projection.tex}
\input{pool/立体几何/中档/q_solid_prism_distance.tex}
\input{pool/立体几何/中档/q_solid_prism_sphere.tex}
\input{pool/立体几何/中档/q_solid_prism_sphere_section.tex}
...
\input{pool/立体几何/中档/q_solid_sphere_section_ratio.tex}
\input{pool/立体几何/中档/q_solid_tetrahedron_vol.tex}
\input{pool/立体几何/基础/q_solid_sphere_models_summary.tex}
\input{pool/立体几何/难题/q_solid_cube_perpendicular.tex}
\input{pool/立体几何/难题/q_solid_cuboid_section.tex}
\input{pool/立体几何/难题/q_solid_practice_isosceles_tetrahedron.tex}
\input{pool/立体几何/难题/q_solid_practice_prism_angle.tex}
\input{pool/立体几何/难题/q_solid_practice_pyramid_dihedral.tex}
\input{pool/立体几何/难题/q_solid_practice_pyramid_dist.tex}
\input{pool/立体几何/难题/q_solid_pyramid_diameter_volume.tex}
\input{pool/立体几何/难题/q_solid_pyramid_point_distance.tex}
\input{pool/立体几何/难题/q_solid_shijiazhuang_prism.tex}
...
% 引入题目宏
\input{pool/立体几何/难题/q_solid_folding_rectangle.tex}
...
\begin{itemize}[leftmargin=2em, itemsep=0.1em, topsep=0.2em]
  ...
  \item 教师在下次课前重点面批刘亚博和谭俊文对第 5 题高考大题的反证放缩及轮换指数消元步骤，纠正其推导书写中可能存在的逻辑跳步或大括号符号书写不规范问题。
\end{itemize}
