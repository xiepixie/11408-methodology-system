% =====================================================
% 题型：平面向量三角形交点解答题 (q_lyb_01_15_triangle_vector.tex)
% =====================================================
% =====================================================
% 难度：★★★ (难题)
% =====================================================
\newcommand{\qVectorTriangleIntersectionStem}{%
...
\newcommand{\qVectorTriangleIntersectionFigure}[1][1.5]{%
...
\newcommand{\qVectorTriangleIntersectionAnswer}{%
  (1) \(\vec{BP} = -\dfrac{3}{4}\vec{a} + \dfrac{1}{4}\vec{b}\)；\\
  (2) \(\sin\angle BPM = \dfrac{4\sqrt{19}}{19}\)。%
}

\newcommand{\qVectorTriangleIntersectionSolution}{%
...
\newcommand{\qVectorTriangleIntersectionDiagnosis}{%
  学生第 (1) 问基本接近正确结论，但第 (2) 问前后参数不一致：先得到 \(\vec{AP}=\frac14\vec a+\frac14\vec b\)，后面又误写为 \(\vec{AP}=\frac23\vec{AM}\)，导致 \(\vec{PM}\)、数量积和夹角计算全部偏离。另有 \(\vec{BP}\) 与 \(\vec{PB}\) 方向混淆风险。%
}

\newcommand{\qVectorTriangleIntersectionTeachingNotes}{%
  必讲。先用两条直线参数法稳定求交点，再强调 \(\angle BPM\) 的两边应从顶点 \(P\) 出发，用 \(\vec{PB}\) 与 \(\vec{PM}\) 计算。%
}
...
% 别名兼容：旧课次宏定义
% =====================================================
\newcommand{\qLYBZeroOneFifteenStem}{\qVectorTriangleIntersectionStem}
\newcommand{\qLYBZeroOneFifteenFigure}[1][1.2]{\qVectorTriangleIntersectionFigure[#1]}
\newcommand{\qLYBZeroOneFifteenAnswer}{\qVectorTriangleIntersectionAnswer}
\newcommand{\qLYBZeroOneFifteenSolution}{\qVectorTriangleIntersectionSolution}
\newcommand{\qLYBZeroOneFifteenDiagnosis}{\qVectorTriangleIntersectionDiagnosis}
\newcommand{\qLYBZeroOneFifteenTeachingNotes}{\qVectorTriangleIntersectionTeachingNotes}
