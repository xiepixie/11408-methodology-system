...
% 难度：★★ (中档)
% =====================================================
\newcommand{\qVectorTriangleIntersectionStem}{在 \(\triangle ABC\) 中，已知 \(\angle BAC=\dfrac{\pi}{2}\)，\(AB=AC\)，\(D\) 是 \(AC\) 的中点。若 \(P\) 是 \(BC\) 上的一点，且满足 \(\overrightarrow{BP}=2\overrightarrow{PC}\)，\(AP\) 与 \(BD\) 交于点 \(E\)，则下列结论正确的是 \hfill （\quad）}

\newcommand{\qVectorTriangleIntersectionOptions}{%
...
\newcommand{\qVectorTriangleIntersectionAnswer}{ACD}

\newcommand{\qVectorTriangleIntersectionFigure}[1][0.85]{%
...
% 别名兼容：旧课次及学生个人宏定义
% =====================================================
\newcommand{\qTJWVectorTriangleIntersectionStem}{\qVectorTriangleIntersectionStem}
\newcommand{\qTJWVectorTriangleIntersectionOptions}{\qVectorTriangleIntersectionOptions}
\newcommand{\qTJWVectorTriangleIntersectionFigure}{\qVectorTriangleIntersectionFigure}
\newcommand{\qTJWVectorTriangleIntersectionAnswer}{\qVectorTriangleIntersectionAnswer}
\newcommand{\qTJWVectorTriangleIntersectionSolution}{\qVectorTriangleIntersectionSolution}
