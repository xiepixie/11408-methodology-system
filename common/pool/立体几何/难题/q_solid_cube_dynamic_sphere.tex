% =====================================================
% 题型：立体几何多选题 (q_tjw_20260605_08_cube_dynamic_sphere.tex)
% =====================================================
% =====================================================
% 难度：★★★ (难题)
% =====================================================
...
\newcommand{\qSolidCubeDynamicSphereDiagnosis}{%
  学生得分率为 50.0\%。说明学生对立体几何的动态面判定、表面爬行展开最值、等体积转换以及外接球求法这几个立体几何综合大模块，存在思维不够全面或者公式掌握不够扎实的问题。
}
...
% 别名兼容：旧课次宏定义
% =====================================================
\newcommand{\qTJWCubeDynamicSphereStem}{\qSolidCubeDynamicSphereStem}
\newcommand{\qTJWCubeDynamicSphereOptions}{\qSolidCubeDynamicSphereOptions}
\newcommand{\qTJWCubeDynamicSphereFigure}[1][1.2]{\qSolidCubeDynamicSphereFigure[#1]}
\newcommand{\qTJWCubeDynamicSphereAnswer}{\qSolidCubeDynamicSphereAnswer}
\newcommand{\qTJWCubeDynamicSphereSolution}{\qSolidCubeDynamicSphereSolution}
\newcommand{\qTJWCubeDynamicSphereDiagnosis}{\qSolidCubeDynamicSphereDiagnosis}
\newcommand{\qTJWCubeDynamicSphereTeachingNotes}{\qSolidCubeDynamicSphereTeachingNotes}
