...
\newcommand{\qSolidPrismSphereDiagnosis}{%
  学生写 \(30^\circ\)，只取了 \(\sin C=\frac12\) 的锐角解，漏掉三角形内角中的钝角解 \(150^\circ\)。%
}
...
% 别名兼容：旧课次宏定义
% =====================================================
\newcommand{\qLYBZeroOneFourteenStem}{\qSolidPrismSphereStem}
\newcommand{\qLYBZeroOneFourteenFigure}[1][1.2]{\qSolidPrismSphereFigure[#1]}
\newcommand{\qLYBZeroOneFourteenAnswer}{\qSolidPrismSphereAnswer}
\newcommand{\qLYBZeroOneFourteenSolution}{\qSolidPrismSphereSolution}
\newcommand{\qLYBZeroOneFourteenDiagnosis}{\qSolidPrismSphereDiagnosis}
\newcommand{\qLYBZeroOneFourteenTeachingNotes}{\qSolidPrismSphereTeachingNotes}
