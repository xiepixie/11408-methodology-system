...
% 别名兼容：旧课次宏定义
% =====================================================
\newcommand{\qLYBZeroOneSevenStem}{\qSolidTetrahedronVolStem}
\newcommand{\qLYBZeroOneSevenOptions}{\qSolidTetrahedronVolOptions}
\newcommand{\qLYBZeroOneSevenFigure}[1][1.2]{\qSolidTetrahedronVolFigure[#1]}
\newcommand{\qLYBZeroOneSevenAnswer}{\qSolidTetrahedronVolAnswer}
\newcommand{\qLYBZeroOneSevenSolution}{\qSolidTetrahedronVolSolution}
