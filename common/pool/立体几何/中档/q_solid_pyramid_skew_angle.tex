% =====================================================
% 题型：立体几何单选题 (q_tjw_20260605_01_pyramid_skew_angle.tex)
% =====================================================
% =====================================================
% 难度：★★ (中档)
% =====================================================
...
\newcommand{\qSolidPyramidSkewAngleDiagnosis}{%
  学生得分率为 0.0\%。学生常见的误区主要集中在异面直线角的定义不清，以及无法灵活在几何平移与空间坐标系之间切换。部分学生容易忽略异面直线角应为锐角或直角这一限制，导致结果出现符号错误，或在构建辅助线时无法有效利用垂直关系简化计算。
}
...
% 别名兼容：旧课次宏定义
% =====================================================
\newcommand{\qTJWPyramidSkewAngleStem}{\qSolidPyramidSkewAngleStem}
\newcommand{\qTJWPyramidSkewAngleOptions}{\qSolidPyramidSkewAngleOptions}
\newcommand{\qTJWPyramidSkewAngleFigure}[1][1.2]{\qSolidPyramidSkewAngleFigure[#1]}
\newcommand{\qTJWPyramidSkewAngleAnswer}{\qSolidPyramidSkewAngleAnswer}
\newcommand{\qTJWPyramidSkewAngleSolution}{\qSolidPyramidSkewAngleSolution}
\newcommand{\qTJWPyramidSkewAngleDiagnosis}{\qSolidPyramidSkewAngleDiagnosis}
\newcommand{\qTJWPyramidSkewAngleTeachingNotes}{\qSolidPyramidSkewAngleTeachingNotes}
